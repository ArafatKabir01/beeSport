...
export default function FixtureCard({ fixture }: any) {
  return (
    <div className='relative mx-2 my-2 lg:mx-0'>
      <Link
        key={fixture._id}
        className='h-24 my-2 p-2 grid grid-cols-12 w-full py-1 lg:py-7 rounded-lg items-center bg-[#F8F8FA] text-md hover:bg-[#E5E7EB] lg:h-full'
