    ...
    <div className='  text-xs'>
          ...
          <div className='relative inline-block text-left'>
            <div className=' '>
              <button
                ...
                type='button'
                className='inline-flex justify-center z-[999] w-17 h-6 rounded-3xl border border-white bg-none px-4   text-sm font-medium shadow-sm hover:text-black hover:bg-[#01C3F7] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
              >
                ...
                <ul className='py-1 '>
                  {options.map((option) => (
                    <li key={option.value}>
                      <a
                        href='#'
                        className='block py-2 text-sm   px-3 hover:bg-indigo-100 rounded-md'
      ...
      <div className='overflow-x-auto py-2 px-1 '>
        <table className='table table-xs select-none w-[98%] border-[0.2px] '>
          {/* head */}
          <thead className='  text-xs rounded-t-lg'>
            <tr>
              <th>Time</th>
              <th>Score</th>
