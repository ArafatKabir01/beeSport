          ...
          <div className='relative inline-block text-left'>
            <div className='flex gap-2 items-center text-xs'>
              ...
              <button
                ...
                type='button'
                className='inline-flex justify-center w-14 h-6 rounded-3xl border border-white bg-none px-1   text-sm font-medium shadow-sm hover:text-black hover:bg-[#01C3F7] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
              >
