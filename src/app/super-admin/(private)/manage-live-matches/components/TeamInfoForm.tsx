...
export default function TeamInfoForm({
  ...
  return (
    <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
      <FormBlockWrapper title='Team One' className='border border-gray-300 rounded-lg p-4'>
      ...
      <FormBlockWrapper title='Team Two' className='border border-gray-300 rounded-lg p-4'>
        <div className='grid grid-cols-1 gap-2'>
