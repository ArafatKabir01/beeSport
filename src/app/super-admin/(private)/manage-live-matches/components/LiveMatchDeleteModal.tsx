import { useDeleteLiveMatchMutation, useGetLiveMatchesQuery } from "@/features/super-admin/live-match/liveMatchApi";
...
export default function LiveMatchDeleteModal({
  ...
  const [deleteLiveMatch, { data, isError, isSuccess }] = useDeleteLiveMatchMutation();
