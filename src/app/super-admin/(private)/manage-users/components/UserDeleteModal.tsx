import { useDeleteUserMutation, useGetUsersQuery } from "@/features/super-admin/user/userApi";
    ...
    <dialog id='userDeleteModal' className='modal'>
      <div className='modal-box'>
        ...
        <div className='flex justify-end'>
          <button
            className='btn btn-error btn-sm   disabled:bg-[#b1032d] disabled:text-[#ffdde5]'
